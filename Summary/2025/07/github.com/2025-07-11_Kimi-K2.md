---
title: 'GitHub - MoonshotAI/Kimi-K2: Kimi K2 is the large language model series developed by Moonshot AI team'
source: https://github.com/MoonshotAI/Kimi-K2
author:
  - github.com
published: ''
fetched: '2025-07-11T17:58:11.040941+00:00'
tags:
  - codex
  - github
image: https://opengraph.githubassets.com/c00db01add97777c6bf79dadbb2ea181374fb4541c878cb492c724ea407f450a/MoonshotAI/Kimi-K2
---

## 要約

Kimi K2はMoonshot AIが公開した1TパラメータのMixture-of-Experts言語モデルで、実際に動作するのは32Bパラメータのみ。Muon optimizerによる安定した大規模学習を15.5兆トークンで行い、推論・コーディング・エージェント用途に強みを持つ。BaseとInstructの2種を提供し、100K超のコンテキストと高度なReasoning機能を備える。評価では多くのベンチマークでSOTA級の性能を示し、モデル構築やデータの詳細手順も公開。分散MoE設計により効率的な推論が可能で、開発者向けにツールやデモを充実させている。学術研究およびビジネス利用を想定した柔軟なライセンスで提供されるため、商用展開も容易。
