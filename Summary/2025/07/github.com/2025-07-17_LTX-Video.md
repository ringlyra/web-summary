...
author:
  - github.com
published: ''
fetched: '2025-07-17T16:46:27.253267+00:00'
tags:
  - codex
  - github
...
LTX-Videoは、実写データを含む大規模な映像データセットで学習した生成AIモデルで、1216×704解像度・30FPSの高品質な動画をリアルタイムで出力できることが特徴です。2025年7月に公開されたバージョン0.9.8では、1枚の画像やキーフレームから最長60秒の映像を生成できるロングショット機能が追加されました。IC-LoRAとの互換性も確保され、13B/2Bの蒸留モデルやディテーラモデルが新たに提供されているため、ComfyUIやDiffusersを通じてより柔軟なワークフローが可能です。プロンプト理解力と描画精度が向上したことで、長尺でも一貫性の高い映像を効率的に作成できます。コミュニティからの改善提案も歓迎されています。
...
- New license for commercial use (https://raw.githubusercontent.com/Lightricks/LTX-Video/master/[OpenRail-M](https:/huggingface.co/Lightricks/LTX-Video/ltx-video-2b-v0.9.5.license.txt))
...
- Improve STG (https://raw.githubusercontent.com/Lightricks/LTX-Video/master/Spatiotemporal Guidance) for LTX-Video
...
- Support for STG / PAG
- Support loading checkpoints of LTX-Video in Diffusers format (https://raw.githubusercontent.com/Lightricks/LTX-Video/master/conversion is done on-the-fly)
...
| Name                    | Notes                                                                                      | inference.py config                                                                                                                                      | ComfyUI workflow (https://raw.githubusercontent.com/Lightricks/LTX-Video/master/Recommended) |
|-------------------------|--------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|
